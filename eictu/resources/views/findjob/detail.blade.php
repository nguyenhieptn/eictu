                ...
                <div class="panel-body">
                    ...
                    <div class="entry-content">
                        <div class='media' style="margin-bottom:15px">
                            <a href='' class='media-left' href='#'><img class='media-object' class="img-rounded"
                                                                        src="<?php echo ($detail->avatar == null) ? "/img/user-image01.png" : $detail->avatar?>"
                                                                        alt=''></a>
                            ...
                            <div class="col-md-12 " style="margin-top: 30px">
                                <div class="col-md-2">
                                    <form action="{{ url('findjob/index') }}">
                                        <Button class="btn btn-danger"><span class="glyphicon glyphicon-send"
                                ...
                                <div class="col-md-10">
                                    @if(Auth::check())
                                        <a style="color:#fff"
                                           href="/chat/friendroom?id={{auth()->user()->username}}&friend={{$detail->code}}"
