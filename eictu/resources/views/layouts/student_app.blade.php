    ...
    @if(Auth::check())
        <div class="col-md-3 col-sm-3">
            <div style="background-color: #ededed;">        
                ...
                ?>
                    <ul class="list-group">
                      <li class="list-group-item<?php ?>" ><span class="glyphicon glyphicon-bullhorn" aria-hidden="true"></span> 
                      ...
                      <li class="list-group-item "><a href="{{url('/rentHouse')}}" <?php  if($arr[1]=='rentHouse') echo "style='color:red !important;'"; ?>>Nhà trọ sinh viên</a></li> 
